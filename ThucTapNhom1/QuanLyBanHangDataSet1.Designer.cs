...
namespace ThucTapNhom1 {
    ...
    public partial class QuanLyBanHangDataSet1 : global::System.Data.DataSet {
        ...
        public partial class KhachHangDataTable : global::System.Data.TypedTableBase<KhachHangRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public KhachHangRow AddKhachHangRow(string idkhachhang, string tenkh) {
...
namespace ThucTapNhom1.QuanLyBanHangDataSet1TableAdapters {
    ...
    public partial class KhachHangTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[KhachHang] WHERE (([idkhachhang] = @Original_idkhachhang) AND " +
                "((@IsNull_tenkh = 1 AND [tenkh] IS NULL) OR ([tenkh] = @Original_tenkh)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[KhachHang] ([idkhachhang], [tenkh]) VALUES (@idkhachhang, @ten" +
                "kh);\r\nSELECT idkhachhang, tenkh FROM KhachHang WHERE (idkhachhang = @idkhachhang" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[KhachHang] SET [idkhachhang] = @idkhachhang, [tenkh] = @tenkh WHERE (([idkhachhang] = @Original_idkhachhang) AND ((@IsNull_tenkh = 1 AND [tenkh] IS NULL) OR ([tenkh] = @Original_tenkh)));
SELECT idkhachhang, tenkh FROM KhachHang WHERE (idkhachhang = @idkhachhang)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idkhachhang, tenkh FROM dbo.KhachHang";
        ...
        public virtual int Delete(string Original_idkhachhang, string Original_tenkh) {
        ...
        public virtual int Insert(string idkhachhang, string tenkh) {
            if ((idkhachhang == null)) {
        ...
        public virtual int Update(string idkhachhang, string tenkh, string Original_idkhachhang, string Original_tenkh) {
            if ((idkhachhang == null)) {
                throw new global::System.ArgumentNullException("idkhachhang");
            }
            else {
            ...
            if ((Original_idkhachhang == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_idkhachhang));
            }
            if ((Original_tenkh == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string tenkh, string Original_idkhachhang, string Original_tenkh) {
            return this.Update(Original_idkhachhang, tenkh, Original_idkhachhang, Original_tenkh);
        }
    }
